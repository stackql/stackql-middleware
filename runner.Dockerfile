...
RUN stackql exec 'registry pull linode'
RUN stackql exec 'registry pull confluent'
RUN stackql exec 'registry pull databricks_account'
RUN stackql exec 'registry pull databricks_workspace'
